...
const Login: Component = () => {
  ...
  const handleOauth = async (e: Event) => {
    e.preventDefault();
    ...
    <>
      ...
      <main class="h-screen flex justify-center items-center w-full p-3">
        ...
        <div class="p-8 flex flex-col z-[10] lg:w-1/3 md:w-1/2 w-full bg-neutral-900">
          ...
          <button onClick={handleOauth} class="bg-neutral-800 text-neutral-400 p-2 flex items-center gap-4 justify-center">
          ...
          <form onSubmit={submit} class="w-full">
            ...
            <button type="submit" class="p-2 w-full bg-red-600">login</button>
          </form>
        </div>
      </main>
    </>
