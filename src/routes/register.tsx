  ...
  return (
    <main class="min-h-screen flex justify-center items-center w-full p-3">
      ...
      <form class="p-8 flex flex-col z-[10] lg:w-1/3 md:w-1/2 w-full bg-neutral-900">
        ...
        <p class="mt-2 mb-6 text-neutral-400">enhance your youtube collaboration expirience today.</p>
        ...
        <div class="group flex flex-col gap-2">
          <div class="flex md:flex-row flex-col px-2 gap-[5px] md:gap-3">
            ...
            <p class="text-red-500">user with this account alr exists</p>
          </div>
        ...
        <div class="group flex flex-col gap-2 mt-4">
          <div class="flex md:flex-row flex-col px-2 gap-[5px] md:gap-3">
            ...
            <p class="text-red-500">user with this email alr exists</p>
          </div>
          <input class="bg-neutral-800 border-none outline-none focus:outline-none p-2" name="email" id="email" autocomplete="off" type="text" />
        </div>
        <div class="group flex mt-4 flex-col gap-2">
          <div class="flex md:flex-row flex-col px-2 gap-[5px] md:gap-3">
            <label class="text-neutral-400" for="password">password</label>
            <p class="text-red-500">should be more than 4 chars long</p>
          </div>
        ...
        <div class="group flex mt-4 flex-col gap-2">
          <div class="flex md:flex-row flex-col px-2 gap-[5px] md:gap-3">
            <label class="text-neutral-400" for="cpassword">confirm password</label>
            <p class="text-red-500">passwords do not match</p>
          </div>
          <input class="bg-neutral-800 border-none outline-none focus:outline-none p-2" name="cpassword" id="cpassword" type="password" autocomplete="off" />
        </div>
        <p class="my-5 text-neutral-400">already registered? <a class="text-red-500 underline" href="/login">log in to existing account </a></p>
        <button type="submit" class="p-2 bg-red-600">register</button>
      </form>
    </main>
  )
}
